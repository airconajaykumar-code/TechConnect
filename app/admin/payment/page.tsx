...
export default function PaymentPage() {
  ...
  function handleSave() {
    localStorage.setItem("tc_upi", upiId);
    setSaved(true);
  ...
  return (
    <div className="p-8">
      ...
      <p className="mt-1 text-gray-500 dark:text-gray-400 dark:text-gray-500">Set your UPI ID for payment collection</p>
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-2">
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white p-6 dark:bg-gray-800">
          ...
          <div className="mt-4 space-y-4">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-400 dark:text-gray-500">
                Enter your Google Pay / PhonePe / Paytm UPI ID
              </p>
            </div>
            <button
              onClick={handleSave}
          ...
          <div className="mt-6 border-t border-gray-100 dark:border-gray-800 pt-6">
            ...
            <ul className="mt-2 space-y-2 text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">
          ...
          {qrUrl ? (
            <div className="mt-6">
              <img
                src={qrUrl}
                alt="Payment QR Code"
                className="mx-auto rounded-xl border border-gray-200 dark:border-gray-700 dark:border-gray-700"
              />
